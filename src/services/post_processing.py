...
def plate_char_diff(placa1, placa2):
    """Mantido por retrocompatibilidade: conta diferenças caractere a caractere de mesmo tamanho."""
...
def detect_plate_typos(divergencias):
    ...
    # Reconstruir lista sem os índices removidos, adicionando os erros de digitação de placa
